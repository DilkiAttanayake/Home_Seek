...
import Form from './Form'; // Assuming the Form component is in the same directory

const Items = () => {
    const [favorites, setFavorites] = useState([]);
    const [items, setItems] = useState([]);
    const [showAdvancedSearch, setShowAdvancedSearch] = useState(false); // Toggle for advanced search
                                ...
                                <ul className="list-group">
                                    {favorites.map(fav => (
                                        <li
                                            ...
                                            style={{ height: '100px', marginBottom: '10px' }} // Added margin
                                            draggable
